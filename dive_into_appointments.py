...
# plt.tight_layout()
# plt.savefig('Top-Affiliations-stacked.png')
# plt.show()
# plt.close()
...
plt.ylabel('Affiliation')
plt.tight_layout()
plt.savefig('Top-Affiliations-active.png')
plt.show()
plt.close()
...
# plt.ylabel('Affiliation')
# plt.tight_layout()
# plt.savefig('Top-Affiliations-CP-groups.png')
# plt.show()
# plt.close()
...
# plt.ylabel('Affiliation')
# plt.tight_layout()
# plt.savefig('Top-Affiliations-ph-groups.png')
# plt.show()
# plt.close()
...
# plt.ylabel('Affiliation')
# plt.tight_layout()
# plt.savefig('Top-Affiliations-CP-groups-active.png')
# plt.show()
# plt.close()
...
plt.ylabel('Affiliation')
plt.tight_layout()
plt.savefig('Top-Affiliations-ph-groups-active.png')
plt.show()
plt.close()